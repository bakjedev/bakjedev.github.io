...
For **block C** of my **second year** at **BUAS** I worked together with a team where we built a **cross-platform** game engine and racing demo in **C++**. I focused on engine systems and the content pipeline:
...
Runs on **PC** and **Steam Deck** (Windows & Linux).
